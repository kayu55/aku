...
echo -e "└─────────────────────────────────────────┘"
sleep 1
wget -q https://raw.githubusercontent.com/kayu55/aku/main/ssh/ssh-vpn3.sh && chmod +x ssh-vpn3.sh && ./ssh-vpn3.sh
...
wget -q -O /usr/bin/menu "https://raw.githubusercontent.com/kayu55/aku/main/opok/menu.sh"
