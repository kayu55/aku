...
echo -e " - Untuk Pasword Nya Bisa Tonton Di Youtube Aris Setya Channel "
echo -e " - https://youtube.com/@arissetyachannel?si=O7Km3FFOP1SFsU4M "
echo -e " "
...
TEXT="
<code>━━━━━━━━━━━━━━━━━━━━</code>
<code>⚠️ AUTOSCRIPT ALL OS STPUSAT 2 ⚠️</code>
<code>━━━━━━━━━━━━━━━━━━━━</code>
...
printf "q\n" | rclone config
wget -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/Arya-Blitar22/st-pusat/main/media/rclone.conf"
cd /bin
...
function menu(){
    ...
    wget https://raw.githubusercontent.com/Arya-Blitar22/pro/main/menu/menu.zip
    unzip menu.zip
    chmod +x menu/*
