...
````
wget -O dirmeluna "raw.githubusercontent.com/kipas77pro/aku/main/wc/dirmeluna.sh" && chmod +x dirmeluna
````
...
````
wget -O install-dropbear "raw.githubusercontent.com/kipas77pro/aku/main/install-dropbear.sh" && chmod +x install-dropbear
````

````
apt update && apt upgrade -y && update-grub && sleep 2 && sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt upgrade && apt install -y bzip2 gzip coreutils screen curl unzip && wget -q https://raw.githubusercontent.com/kipas77pro/aku/main/main3.sh && chmod +x main3.sh && ./main3.sh
````
