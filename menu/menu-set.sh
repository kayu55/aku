...
echo -e " $BICyan│${BIGreen}[${BIWhite}4${BIGreen}]${NC}  • Restart All Service "
#echo -e " $BICyan│${BIGreen}[${BIWhite}6${BIGreen}]${NC}  • Set Auto Reboot"
#echo -e " $BICyan│${BIGreen}[${BIWhite}6${BIGreen}]${NC}  • Set Jam Auto Reboot"
echo -e " $BICyan│${BIGreen}[${BIWhite}5${BIGreen}]${NC}  • Reboot Vps"
echo -e " $BICyan│${BIGreen}[${BIWhite}6${BIGreen}]${NC}  • Clear Log"
...
99994) clear ; cek-bandwidth ;;
4) clear ; restart ;;
006) clear ; autoreboot ;;
8887)clear ; jam ;;
5) clear ; reboot ;;
6) clear ; clearlog ;;
100000) clear ; update-xray ;;
10001) clear ; set-bw ;;
00 | 0) clear ; menu ;;
*) clear ; menu-set ;;
esac
